...
<body>
	<div id="container">
		<div id="contentWrap">
			<form id="frmCommon" name="frmCommon" action="/commonNicList.do" method="post">
			...
			<div class="date-btn">
				<div class="date">
					...
					<div class="calendar-search2">
						...
						<input type="radio" class="radio" id="schGb2" name="schGbCond" value="N" title="구분명" /><label for="schGb2">구분명</label>
					</div>
			...
			<table summary="닉네임 검색" class="board-list">
				...
				<tbody>
					...
					<c:forEach items="${list}" var="imgGb">
					<tr class="curPointer" onclick="javascript:choiceCode(this);" data="${imgGb.itemCd1}|${imgGb.itemNm1}">
						<td class="txt_ac"><fmt:parseNumber value="${imgGb.seq}" var="seqFmt"  type="number"/>${seqFmt}</td>
						<td class="txt_ac">${imgGb.itemCd2}</td>
						<td class="txt_ac">${imgGb.itemNm2}</td>
					</tr>
					</c:forEach>
					</c:if>
