...
<body>
	<div id="container">
		<div id="contentWrap">
			<form id="frmCommon" name="frmCommon" action="/commonAccList.do" method="post">
			...
			<div class="date-btn">
				<div class="date">
					...
					<div class="calendar-search2">
						...
						<input type="radio" class="radio" id="schGb2" name="schGbCond" value="N" title="상품명" /><label for="schGb2">상품명</label>
					</div>
			...
			<table summary="닉네임 검색" class="board-list">
				...
				<tbody>
					...
					<tr class="curPointer" onclick="javascript:choiceCode(this);" data="${acc.itemCd1}|${acc.itemNm1}">
						<td class="txt_ac"><fmt:parseNumber value="${acc.seq}" var="seqFmt"  type="number"/>${seqFmt}</td>
						<td class="txt_ac">${acc.itemCd2}</td>
						<td class="txt_ac">${acc.itemNm2}</td>
					</tr>
					</c:forEach>
					</c:if>
