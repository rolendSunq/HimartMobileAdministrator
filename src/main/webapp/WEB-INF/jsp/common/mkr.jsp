...
<body>
	<div id="container">
		<div id="contentWrap">
			<form id="frmCommon" name="frmCommon" action="/commonMkrList.do" method="post">
			...
			<div class="date-btn">
				<div class="date">
					...
					<div class="calendar-search2">
						...
						<input type="radio" class="radio" id="schGb2" name="schGbCond" value="N" title="제조사" /><label for="schGb2">제조사</label>
					</div>
			...
			<table summary="제조사 검색" class="board-list">
				<colgroup>
					<col style="width:10%" />
					<col style="width:30%" />
					<col style="width:60%" />
				...
				<tbody>
					...
					<c:forEach items="${list}" var="mkr">
					<tr class="curPointer" onclick="javascript:choiceCode(this);" data="${mkr.itemCd1}|${mkr.itemNm1}">
						<td class="txt_ac"><fmt:parseNumber value="${mkr.seq}" var="seqFmt"  type="number"/>${seqFmt}</td>
						<td class="txt_ac">${mkr.itemCd2}</td>
						<td class="txt_ac">${mkr.itemNm2}</td>
					</tr>
					</c:forEach>
					</c:if>
