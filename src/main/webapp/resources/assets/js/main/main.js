...
function initialize() {
    ...
    $("iframe#contentArea").load(function() {
      if ($(this).attr("src").indexOf("/recomHoffice.do") >= 0) {
        $("#btnRecomHoffice").prop("src", "/resources/assets/image/btn_hq_on.png");
        $("#btnImageUpload").prop("src", "/resources/assets/image/btn_img.png");
        $("#btnLogCounsel").prop("src", "/resources/assets/image/btn_counsel.png");
        $("#btnThumbnailUpload").prop("src", "/resources/assets/image/btn_thumbnail.png");
        ...
        $("#btnRecomHoffice").prop("src", "/resources/assets/image/btn_hq.png");
        $("#btnImageUpload").prop("src", "/resources/assets/image/btn_img_on.png");
        $("#btnLogCounsel").prop("src", "/resources/assets/image/btn_counsel.png");
        $("#btnThumbnailUpload").prop("src", "/resources/assets/image/btn_thumbnail.png");
        ...
        $("#btnRecomHoffice").prop("src", "/resources/assets/image/btn_hq.png");
        $("#btnImageUpload").prop("src", "/resources/assets/image/btn_img.png");
        $("#btnLogCounsel").prop("src", "/resources/assets/image/btn_counsel_on.png");
        $("#btnThumbnailUpload").prop("src", "/resources/assets/image/btn_thumbnail.png");
        ...
        $("#btnThumbnailUpload").addClass("curPointer");
          ...
          $("#btnImageUpload").prop("src", "/resources/assets/image/btn_img.png");
          $("#btnLogCounsel").prop("src", "/resources/assets/image/btn_counsel.png");
          $("#btnThumbnailUpload").prop("src", "/resources/assets/image/btn_thumbnail_on.png");
